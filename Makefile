...
SHAStatusHomeBarAdjusterPrefs_RESOURCE_FILES = Preferences/Root.plist
...
after-stage::
	...
	@cp Preferences/SHAStatusHomeBarAdjusterPrefs.plist $(THEOS_STAGING_DIR)/Library/PreferenceLoader/Preferences/
